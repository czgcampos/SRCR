...
% Invariante Referencial: nao admitir mais do que 4 avôs para um mesmo individuo
...
% Invariante Referencial: não é possivel remover filhos para os quais existe registo de idade
